...
def write_mutational_signature_subset(sig_path: Path, sig_names_path: Path, output_path: Path):
    # Load signatures
...
def main():
    ...
    write_mutational_signature_subset(options.sig, options.sig_names, options.output)
    sys.exit(0)
